...
(function(window) {
    ...
    template += '<label for="country" class="col-md-3 col-sm-3 col-xs-12 field-name text-padding">{{countryLabel}}<a class="req">*</a></label>';
        ...
        .directive("countryStateSelect", [ function () {
            return {
                ...
                link: function (scope, element, attrs) {
                   ...
                   scope.state[237]="Avon|Aberdeen|Aberdeenshire|Anglesey|Angus|Antrim|Argyll|Armagh|Ayrshire|Banffshire|Bedfordshire|Berkshire|Berwickshire|Borders|Brecknockshire|Bristol|Buckinghamshire|Bute|Caernarfonshire|Caithness|Cambridgeshire|Cambridgeshire and Isle of Ely|Cardiganshire|Carmarthenshire|Central|Cheshire|Clackmannanshire|Cleveland|Clwyd|Cornwall|Cromartyshire|Cumberland|Cumbria|Denbighshire|Derbyshire|Derry|Devon|Dorset|Down|Dumfries and Galloway|Dumfriesshire|Dunbartonshire|Dundee|Durham|Dyfed|East Lothian|Edinburgh|East Suffolk|East Sussex|Essex|Flintshire|Fife|Fermanagh|Glamorgan|Glasgow|Gloucestershire|Greater London|Grampian|Greater Manchester|Gwent|Gwynedd County|Hampshire|Hereford and Worcester|Herefordshire|Hertfordshire|Huntingdon and Peterborough|Huntingdonshire|Highlands and Islands|Humberside|Inverness-shire|Isle of Ely|Isle of Wight|Kincardineshire|Kinross-shire|Kirkcudbrightshire|Kent|Lanarkshire|Lancashire|Leicestershire|Lincolnshire|London|Londonderry|Lothian|Merionethshire|Merseyside|Midlothian|Moray|Mid Glamorgan|Monmouthshire|Montgomeryshire|Middlesex|Norfolk|North Humberside|North Yorkshire|Northamptonshire|Nairnshire|Northumberland|Nottinghamshire|Orkney|Oxfordshire|Peeblesshire|Pembrokeshire|Powys|Perthshire|Powys|Radnorshire|Rutland|Renfrewshire|Ross and Cromarty|Ross-shire|Roxburghshire|Selkirkshire|Shetland|Stirlingshire|Soke of Peterborough|Shropshire|Somerset|South Humberside|South Glamorgan|Sutherland|South Yorkshire|Staffordshire|Strathclyde|Suffolk|Surrey|Sussex|Tayside|Tyne and Wear|Tyrone|Warwickshire|West Glamorgan|West Midlands|West Sussex|Westmorland|West Suffolk|West Lothian|West Yorkshire|Wiltshire|Worcestershire|Wrexham";
					...
					//This Function Is Use To Load Seleted Country County On Edit Page.
